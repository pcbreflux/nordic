...
#define QDEC_CONFIG_SAMPLEPER    NRF_QDEC_SAMPLEPER_1024us  
#define QDEC_CONFIG_PIO_A        24
#define QDEC_CONFIG_PIO_B        25
#define QDEC_CONFIG_PIO_LED      0xFFFFFFFF
#define QDEC_CONFIG_LEDPRE       0
#define QDEC_CONFIG_LEDPOL       NRF_QDEC_LEPOL_ACTIVE_HIGH
#define QDEC_CONFIG_IRQ_PRIORITY APP_IRQ_PRIORITY_LOW
#define QDEC_CONFIG_DBFEN        true
